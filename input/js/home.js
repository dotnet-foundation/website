...
$(document).ready(function () {
    var presetEvents = document.getElementById('PresetVirtualEvents');
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            var events = [];
            meetups.slice().sort((a, b) => new Date(b.local_date) - new Date(a.local_date)).reverse().slice(0, 3).map(m => {
